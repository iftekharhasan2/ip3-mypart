...
import { PolicyShowcaseSection } from './PolicyShowcaseSection';
import { Ip3PolicySection } from './Ip3PolicySection';
...
export const AboutPage: React.FC<AboutPageProps> = ({
  ...
  useEffect(() => {
    if (initialSection) {
      ...
      } else if (initialSection.includes('policy-showcase') || initialSection.includes('showcase')) {
        ...
        {activeTab === 'approach' && (
          ...
          >
            <div className="max-w-7xl mx-auto space-y-16">
              ...
              {/* IP3 Policy Architecture Framework & Action Research Tree Section */}
              <div className="border-t border-slate-800/80 pt-12 space-y-6">
                <div className="text-center max-w-3xl mx-auto space-y-3 mb-4">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#ff7e67]/10 border border-[#ff7e67]/30 text-xs font-mono font-bold text-[#ff7e67]">
                    <span>SYSTEMIC ARCHITECTURE CORE</span>
                  </div>
                  <h3 className="text-2xl sm:text-4xl font-extrabold text-slate-100">
                    IP3 Policy Architecture Framework
                  </h3>
                  <p className="text-xs sm:text-sm text-slate-400 max-w-2xl mx-auto">
                    Explore our integrated policy framework tree, 4 structural pillars, action research trials, and customized institutional solutions.
                  </p>
                </div>
